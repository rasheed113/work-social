...
export function LocalAiDiagnosticCard({ diagnostic }: { diagnostic: LocalAiDiagnostic }) {
  ...
  return <details className="ws-local-ai-diagnostic" open={false}>
    ...
    <style>{`.ws-local-ai-diagnostic{margin-top:10px;border:1px solid rgba(148,163,184,.18);border-radius:12px;background:rgba(15,23,42,.42);color:#cbd5e1;box-sizing:border-box;font:500 11px/1.4 inherit;overflow:hidden}.ws-local-ai-diagnostic-summary{padding:9px 11px;cursor:pointer;list-style:none;font-size:10px;font-weight:800;letter-spacing:.02em;color:#94a3b8}.ws-local-ai-diagnostic-summary::-webkit-details-marker{display:none}.ws-local-ai-diagnostic-summary span{display:inline-block;margin-left:4px;transition:transform .15s ease}.ws-local-ai-diagnostic[open] .ws-local-ai-diagnostic-summary span{transform:rotate(90deg)}.ws-local-ai-diagnostic-summary:focus-visible{outline:2px solid currentColor;outline-offset:-2px}.ws-local-ai-diagnostic-content{padding:0 10px 10px;min-width:0}.ws-local-ai-diagnostic-title{font-size:11px;font-weight:900;margin-bottom:8px;color:#e2e8f0}.ws-local-ai-diagnostic-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;min-width:0}.ws-local-ai-diagnostic-grid>div{min-width:0;padding:6px 7px;border:1px solid rgba(148,163,184,.10);border-radius:8px;background:rgba(0,0,0,.10)}.ws-local-ai-diagnostic-grid .wide{grid-column:1/-1}.ws-local-ai-diagnostic-grid b{display:block;font-size:9px;text-transform:uppercase;letter-spacing:.06em;color:#94a3b8;margin-bottom:2px}.ws-local-ai-diagnostic-grid span{display:block;overflow-wrap:anywhere;color:#cbd5e1}.ws-local-ai-diagnostic-copy{margin-top:8px;border:1px solid rgba(148,163,184,.20);border-radius:8px;padding:7px 9px;background:rgba(51,65,85,.32);color:#e2e8f0;font:800 10px/1 inherit;cursor:pointer}.ws-local-ai-diagnostic-copy:focus-visible{outline:2px solid currentColor;outline-offset:2px}.ws-ai-panel:has(.ws-ai-offline-status){overflow-y:auto!important;overflow-x:auto!important;overscroll-behavior:contain;scrollbar-gutter:stable}.ws-ai-panel:has(.ws-ai-offline-status)>*{min-width:0!important}.ws-ai-panel:has(.ws-ai-offline-status) .ws-ai-offline-status,.ws-ai-panel:has(.ws-ai-offline-status) .ws-ai-local-import,.ws-ai-panel:has(.ws-ai-offline-status) .ws-local-ai-diagnostic{max-width:100%;min-width:0}@media(max-width:520px){.ws-local-ai-diagnostic-grid{grid-template-columns:1fr}.ws-local-ai-diagnostic-grid .wide{grid-column:auto}}`}</style>
  </details>;
}
