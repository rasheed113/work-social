  ...
  return (
    <>
      <style>{`
        ...
        .ws-ai-panel{position:fixed;right:18px;bottom:150px;z-index:1499;width:min(920px,calc(100vw - 36px));height:min(720px,calc(100dvh - 190px));display:grid;grid-template-columns:220px minmax(0,1fr);overflow:hidden;border:1px solid rgba(255,255,255,.16);border-radius:24px;background:linear-gradient(145deg,rgba(8,14,28,.98),rgba(17,24,39,.98));color:#e5eefb;box-shadow:0 28px 80px rgba(2,6,23,.5),inset 0 1px 0 rgba(255,255,255,.08);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px)}
        ...
        .ws-ai-main{min-width:0;display:flex;flex-direction:column;height:100%}
        .ws-ai-header{display:flex;align-items:center;gap:10px;padding:15px 17px;border-bottom:1px solid rgba(255,255,255,.1)}
        ...
        .ws-ai-messages{flex:1;min-height:0;overflow:auto;padding:18px;display:flex;flex-direction:column;gap:11px}
        ...
        .ws-ai-error{margin:0 17px 10px;padding:9px 11px;border:1px solid rgba(248,113,113,.25);border-radius:10px;background:rgba(127,29,29,.18);color:#fecaca;font-size:11px;line-height:1.4}
        .ws-ai-composer{display:flex;gap:9px;padding:13px;border-top:1px solid rgba(255,255,255,.1);background:rgba(2,6,23,.24)}
        .ws-ai-input{min-width:0;flex:1;resize:none;max-height:120px;padding:11px 12px;border:1px solid rgba(255,255,255,.13);border-radius:13px;outline:none;background:rgba(255,255,255,.055);color:#fff;font:inherit;font-size:13px}.ws-ai-input:focus{border-color:rgba(96,165,250,.55);box-shadow:0 0 0 3px rgba(59,130,246,.1)}
        .ws-ai-send{width:46px;border:0;border-radius:13px;background:linear-gradient(145deg,#2563eb,#7c3aed);color:#fff;font-weight:900;cursor:pointer}.ws-ai-send:disabled{opacity:.5;cursor:not-allowed}
        ...
        @media(max-width:680px){.ws-ai-panel{right:8px;bottom:142px;width:calc(100vw - 16px);height:calc(100dvh - 165px);grid-template-columns:1fr}.ws-ai-history{display:none}.ws-ai-launcher{right:14px;bottom:78px}.ws-ai-bubble{max-width:88%}}
      `}</style>
