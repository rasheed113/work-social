  ...
  return (
    <main style={{ width: '100%', maxWidth: 760, margin: '0 auto', padding: '24px 14px 112px', boxSizing: 'border-box' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18 }}>
        <button type="button" onClick={() => navigate('/work')} aria-label="Back to Work House">←</button>
        <div>
          <h1 style={{ margin: 0 }}>Work Identity</h1>
          <p style={{ margin: '4px 0 0', color: '#64748b', fontSize: 13 }}>Tell Work House what you do.</p>
        </div>
      </div>
