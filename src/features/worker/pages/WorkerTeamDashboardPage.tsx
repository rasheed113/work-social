...
export function WorkerTeamDashboardPage() {
  ...
  const title = view === 'dashboard' ? `${team?.team_name ?? 'Team'} Dashboard` : view === 'finance' ? 'Team Finance' : 'Team Settings';
  ...
  return (
    <main className="team-dashboard-page">
      ...
      <div className="td-shell">
        <div className="td-top"><button className="td-back" type="button" onClick={() => navigate('/work/team-work')} aria-label="Back to My Teams">‹</button><div><div className="td-kicker">TEAM DASHBOARD · {team.team_number}</div><h1 className="td-title">{title}</h1></div></div>
        ...
        <nav className="td-nav" aria-label="Team workspace navigation">
        ...
        <section className="td-panel">
          ...
          {view === 'dashboard' && <div className="td-empty">No personal My Work totals are shown here. Real Team Work assignments and Team totals will be attached to this Team Dashboard in the next data slice.</div>}
