...
export function WorkerNewWorkEntryModal({ open, saving, onClose, onSave }: WorkerNewWorkEntryModalProps) {
  ...
  return (
    <div style={overlayStyle} role="presentation" onMouseDown={(event) => { if (event.target === event.currentTarget) resetAndClose(); }}>
      <style>{`.new-entry-surface .new-entry-title{color:#e9d5ff!important;text-shadow:0 0 18px rgba(168,85,247,.24)}.new-entry-surface .new-entry-kicker{color:#67e8f9!important;text-shadow:0 0 10px rgba(34,211,238,.2)}.new-entry-surface label{color:#67e8f9!important}.new-entry-surface p{color:#a5b4fc!important}.new-entry-surface input,.new-entry-surface textarea{color:#f0abfc!important}.new-entry-surface input::placeholder,.new-entry-surface textarea::placeholder{color:#818cf8!important}.new-entry-surface button{color:#67e8f9}.new-entry-surface button:hover{color:#f0abfc}.new-entry-surface .new-entry-total{color:#f0abfc!important}.new-entry-surface .new-entry-error{color:#fda4af!important}\
        .new-entry-surface{position:relative;width:100%;max-width:560px;max-height:calc(100dvh - 20px);overflow-y:auto;box-sizing:border-box;border:1px solid rgba(79,142,160,.22);border-radius:20px;background:rgba(15,23,42,.94);padding:13px 14px calc(14px + env(safe-area-inset-bottom));color:#e2e8f0;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;box-shadow:inset 0 2px 0 rgba(255,255,255,.99),inset 0 -2px 0 rgba(100,116,139,.1),0 2px 0 rgba(255,255,255,.96),0 5px 0 rgba(148,163,184,.14),0 10px 24px rgba(15,23,42,.14),0 22px 46px rgba(15,23,42,.13);}\
        ...
        .new-entry-kicker{color:#67e8f9;font-size:10px;font-weight:900;letter-spacing:.08em;text-transform:uppercase;line-height:1.2;text-shadow:0 1px 0 #fff;}\
        .new-entry-title{margin:4px 0 0;font-size:21px;line-height:1.05;font-weight:950;letter-spacing:-.035em;color:#f8fafc;text-shadow:0 1px 0 rgba(255,255,255,.08),0 1px 0 rgba(100,116,139,.2),0 3px 5px rgba(15,23,42,.08);}\
        .new-entry-close{min-width:34px!important;min-height:34px!important;border:1px solid rgba(100,116,139,.25)!important;border-radius:10px!important;background:rgba(30,41,59,.92)!important;color:#e2e8f0;font:inherit;font-size:18px;line-height:1;cursor:pointer;box-shadow:inset 0 1px 0 #fff,0 2px 0 rgba(148,163,184,.2),0 4px 8px rgba(15,23,42,.08);transition:transform .12s ease,box-shadow .12s ease;}\
        ...
        .new-entry-field-label{font-size:11px;font-weight:850;color:#cbd5e1;line-height:1.2;}\
        .new-entry-control{width:100%;min-width:0;min-height:42px;box-sizing:border-box;border:1px solid rgba(71,112,127,.24);border-radius:11px;padding:0 10px;background:rgba(15,23,42,.72);color:#f8fafc;font:inherit;font-size:13px;font-weight:750;outline:none;box-shadow:inset 0 2px 0 rgba(255,255,255,.98),inset 0 -2px 4px rgba(100,116,139,.08),0 2px 0 rgba(255,255,255,.9),0 3px 7px rgba(15,23,42,.075);transition:transform .13s ease,box-shadow .13s ease,border-color .13s ease;}\
        ...
        .new-entry-context{min-height:42px;box-sizing:border-box;padding:10px 11px;border:1px solid rgba(148,163,184,.2);border-radius:11px;background:rgba(15,23,42,.58);color:#cbd5e1;box-shadow:inset 0 1px 0 #fff,inset 0 -1px 0 rgba(100,116,139,.08),0 2px 5px rgba(15,23,42,.05);}\
        .new-entry-size-trigger{min-height:42px!important;padding:0 10px!important;border:1px solid rgba(71,112,127,.24)!important;border-radius:11px!important;background:rgba(15,23,42,.72)!important;color:#94a3b8;font:inherit;font-size:13px;font-weight:750;text-align:left;box-shadow:inset 0 2px 0 #fff,inset 0 -2px 4px rgba(100,116,139,.08),0 2px 0 #fff,0 3px 7px rgba(15,23,42,.075)!important;transition:transform .13s ease,box-shadow .13s ease,border-color .13s ease;}\
        ...
        .new-entry-total{padding:10px 11px!important;border-radius:12px!important;background:linear-gradient(145deg,rgba(8,47,73,.72),rgba(15,118,110,.34))!important;border:1px solid rgba(56,189,248,.28)!important;box-shadow:inset 0 2px 0 rgba(255,255,255,.98),inset 0 -2px 0 rgba(13,148,136,.08),0 2px 0 rgba(255,255,255,.9),0 4px 9px rgba(14,116,144,.08);}\
        ...
        .new-entry-note{min-height:68px;box-sizing:border-box;padding:9px 10px;border:1px solid rgba(71,112,127,.24);border-radius:11px;background:rgba(15,23,42,.72);color:#f8fafc;font:inherit;font-size:13px;line-height:1.4;resize:vertical;outline:none;box-shadow:inset 0 2px 0 #fff,inset 0 -2px 4px rgba(100,116,139,.08),0 2px 0 #fff,0 3px 7px rgba(15,23,42,.075);}\
        ...
        .new-entry-error{margin:0!important;padding:7px 9px;border:1px solid rgba(239,68,68,.2);border-radius:9px;background:rgba(127,29,29,.28);color:#fca5a5;font-size:11px;line-height:1.35;font-weight:750;}\
        ...
        .work-size-picker-panel { width: 100%; max-height: min(78dvh, 620px); overflow-y: auto; box-sizing: border-box; border-radius: 24px 24px 0 0; background: rgba(15,23,42,.92); box-shadow: 0 -18px 60px rgba(15,23,42,.2); padding: 10px 16px calc(18px + env(safe-area-inset-bottom)); animation: work-size-slide-up 220ms cubic-bezier(.22,1,.36,1); }\
        .work-size-option { min-height: 48px; width: 100%; border: 1px solid #e2e8f0; border-radius: 14px; background: rgba(15,23,42,.78); color: #e2e8f0; font: inherit; font-size: 15px; font-weight: 800; text-align: left; padding: 0 14px; cursor: pointer; transition: transform 120ms ease, background 120ms ease, border-color 120ms ease; }\
        .work-size-option:active { transform: scale(.985); }\
        .work-size-option[data-selected="true"] { border-color: #4f46e5; background: rgba(79,70,229,.34); color: #c4b5fd; }\
        ...
        .work-size-custom-input { width: 100%; min-height: 48px; box-sizing: border-box; border: 1px solid #cbd5e1; border-radius: 14px; padding: 0 13px; font: inherit; color: #f8fafc; background: rgba(15,23,42,.78); }\
      ...
      .new-entry-surface,.new-entry-surface *{color:#e2e8f0}.new-entry-surface h2,.new-entry-surface h3{color:#f8fafc!important}.new-entry-surface input,.new-entry-surface textarea{color:#f8fafc!important}.new-entry-surface input::placeholder,.new-entry-surface textarea::placeholder{color:#7f93aa!important}.new-entry-surface [style*="color: '#172033'"],.new-entry-surface [style*="color: '#123b50'"],.new-entry-surface [style*="color: '#155e75'"],.new-entry-surface [style*="color: '#3730a3'"]{color:#f8fafc!important}.new-entry-surface [style*="color: '#527083'"],.new-entry-surface [style*="color: '#64748b'"]{color:#a9b8ca!important}.new-entry-surface [style*="background: '#e8f7f8'"],.new-entry-surface [style*="background: '#eef2ff'"]{background:rgba(56,189,248,.14)!important}.work-size-picker-panel,.work-size-picker-panel *{color:#e2e8f0}.work-size-picker-panel h3{color:#f8fafc!important}.work-size-picker-control{color:#f8fafc!important;background:rgba(30,41,59,.82)!important;border-color:rgba(103,232,249,.18)!important}.work-size-picker-panel p{color:#a9b8ca!important}.work-size-picker-panel [style*="border-top: '1px solid #e2e8f0'"]{border-color:rgba(148,163,184,.22)!important}`}</style>
