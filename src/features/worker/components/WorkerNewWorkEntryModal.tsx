...
export function WorkerNewWorkEntryModal({ open, saving, onClose, onSave }: WorkerNewWorkEntryModalProps) {
  ...
  return (
    <div style={overlayStyle} role="presentation" onMouseDown={(event) => { if (event.target === event.currentTarget) resetAndClose(); }}>
      ...
      .new-entry-surface,.new-entry-surface *{color:#c4b5fd}.new-entry-surface h2,.new-entry-surface h3{color:#e9d5ff!important}.new-entry-surface input,.new-entry-surface textarea{color:#f0abfc!important}.new-entry-surface input::placeholder,.new-entry-surface textarea::placeholder{color:#7f93aa!important}.new-entry-surface [style*="color: '#172033'"],.new-entry-surface [style*="color: '#123b50'"],.new-entry-surface [style*="color: '#155e75'"],.new-entry-surface [style*="color: '#3730a3'"]{color:#f8fafc!important}.new-entry-surface [style*="color: '#527083'"],.new-entry-surface [style*="color: '#64748b'"]{color:#a9b8ca!important}.new-entry-surface [style*="background: '#e8f7f8'"],.new-entry-surface [style*="background: '#eef2ff'"]{background:rgba(56,189,248,.14)!important}.work-size-picker-panel,.work-size-picker-panel *{color:#c4b5fd}.work-size-picker-panel h3{color:#e9d5ff!important}.work-size-picker-control{color:#f8fafc!important;background:rgba(30,41,59,.82)!important;border-color:rgba(103,232,249,.18)!important}.work-size-picker-panel p{color:#a5b4fc!important}.work-size-picker-panel [style*="border-top: '1px solid #e2e8f0'"]{border-color:rgba(148,163,184,.22)!important}`}</style>
