...
.received-type-segmented{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:4px;width:100%;min-width:0;padding:4px;box-sizing:border-box;border:1px solid rgba(71,112,127,.22);border-radius:12px;background:linear-gradient(180deg,#ffffff 0%,#f7fbfc 45%,#e7f0f2 100%);box-shadow:inset 0 2px 4px rgba(100,116,139,.09),inset 0 1px 0 rgba(255,255,255,.98),0 2px 0 rgba(255,255,255,.92),0 4px 9px rgba(15,23,42,.09);}
.received-type-option{position:relative;min-width:0;min-height:34px;padding:0 9px;border:1px solid rgba(148,163,184,.18);border-radius:8px;background:linear-gradient(180deg,#ffffff 0%,#f7fafb 50%,#e8eff1 100%);color:#425466;font:inherit;font-size:12px;font-weight:850;letter-spacing:.005em;line-height:1;cursor:pointer;outline:none;text-align:center;text-shadow:0 1px 0 #fff;box-shadow:inset 0 1px 0 rgba(255,255,255,.98),inset 0 -1px 0 rgba(100,116,139,.08),0 2px 0 rgba(255,255,255,.9),0 3px 6px rgba(15,23,42,.08);transition:transform .13s ease,box-shadow .13s ease,background .13s ease,border-color .13s ease,color .13s ease;}
.received-type-option::before{content:"";position:absolute;left:5px;right:5px;top:2px;height:42%;border-radius:7px 7px 55% 55%;background:linear-gradient(180deg,rgba(255,255,255,.9),rgba(255,255,255,0));pointer-events:none;}
.received-type-option:hover:not(:disabled){transform:translateY(-1px);box-shadow:inset 0 1px 0 rgba(255,255,255,.99),inset 0 -1px 0 rgba(100,116,139,.07),0 3px 0 rgba(255,255,255,.94),0 5px 9px rgba(15,23,42,.1);}
.received-type-option:active:not(:disabled){transform:translateY(2px) scale(.985);background:linear-gradient(180deg,#e4eef1 0%,#f4f8f9 100%);box-shadow:inset 0 3px 5px rgba(15,23,42,.14),inset 0 1px 0 rgba(255,255,255,.82),0 1px 0 rgba(255,255,255,.8);}
.received-type-option:focus-visible{z-index:2;border-color:rgba(14,116,144,.55);box-shadow:0 0 0 3px rgba(20,184,166,.16),inset 0 1px 0 rgba(255,255,255,.99),0 3px 7px rgba(15,23,42,.1);}
.received-type-option.is-selected{border-color:rgba(14,116,144,.48);background:linear-gradient(180deg,#ecffff 0%,#d7f2f2 48%,#b6dfdf 100%);color:#0f5264;box-shadow:inset 0 2px 0 rgba(255,255,255,.98),inset 0 -2px 0 rgba(14,116,144,.18),0 2px 0 rgba(255,255,255,.9),0 4px 0 rgba(71,85,105,.16),0 7px 12px rgba(15,118,110,.13);text-shadow:0 1px 0 rgba(255,255,255,.98),0 1px 2px rgba(15,23,42,.1);}
.received-type-option.is-selected:hover:not(:disabled){transform:translateY(-1px);box-shadow:inset 0 2px 0 rgba(255,255,255,.99),inset 0 -2px 0 rgba(14,116,144,.18),0 3px 0 rgba(255,255,255,.92),0 6px 12px rgba(15,118,110,.15);}
.received-type-option.is-selected:active:not(:disabled){transform:translateY(1px) scale(.985);box-shadow:inset 0 3px 6px rgba(15,23,42,.13),inset 0 1px 0 rgba(255,255,255,.82),0 1px 0 rgba(255,255,255,.8);}
.received-type-option:disabled{cursor:not-allowed;opacity:.62;transform:none;}
...
@media (max-width:360px){.received-modal-surface{padding-left:11px;padding-right:11px;border-radius:18px}.received-modal-form{gap:9px}.received-modal-control{min-height:40px}.received-modal-actions{gap:7px}.received-modal-actions button{min-height:38px;padding:0 11px}.received-type-segmented{gap:3px;padding:3px}.received-type-option{min-height:33px;padding:0 7px;font-size:11.5px}}
`}</style></div>; }
