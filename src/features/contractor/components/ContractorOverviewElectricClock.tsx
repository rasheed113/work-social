...
const styles = `.coec{position:relative;display:flex;align-items:center;min-height:31px;margin:0 0 4px;overflow:hidden;border:1px solid rgba(183,255,0,.22);border-radius:12px;background:linear-gradient(105deg,rgba(4,10,18,.99),rgba(12,22,17,.97) 52%,rgba(7,14,12,.99));box-shadow:0 8px 22px rgba(2,6,23,.22),0 0 20px rgba(183,255,0,.08),inset 0 1px 0 rgba(255,255,255,.1),inset 0 -7px 15px rgba(0,0,0,.28)}.coec:before,.coec:after{content:"";position:absolute;z-index:4;top:0;bottom:0;width:30px;pointer-events:none}.coec:before{left:0;background:linear-gradient(90deg,#06100b,transparent)}.coec:after{right:0;background:linear-gradient(270deg,#06100b,transparent)}.coec-glow{position:absolute;inset:-24px;pointer-events:none;background:radial-gradient(circle at 17% 50%,rgba(183,255,0,.18),transparent 25%),radial-gradient(circle at 78% 50%,rgba(34,211,238,.08),transparent 28%);filter:blur(10px)}.coec-label{position:relative;z-index:5;display:flex;align-items:center;gap:6px;flex:0 0 auto;height:25px;margin-left:3px;padding:0 10px;border-radius:9px;background:linear-gradient(135deg,rgba(21,36,17,.98),rgba(38,61,15,.94));border:1px solid rgba(183,255,0,.2);box-shadow:0 5px 13px rgba(0,0,0,.3),0 0 12px rgba(183,255,0,.08),inset 0 1px 0 rgba(255,255,255,.13);color:#d9ff8a;font-size:7px;font-weight:950;letter-spacing:.13em}.coec-label i{width:5px;height:5px;border-radius:50%;background:#b7ff00;box-shadow:0 0 5px #b7ff00,0 0 12px #b7ff00,0 0 20px rgba(183,255,0,.8);animation:coec-live 1.4s steps(2,end) infinite}.coec-time{position:relative;z-index:5;flex:0 0 auto;min-width:78px;margin-left:8px;color:#b7ff00;font-size:10px;font-weight:950;letter-spacing:.07em;font-variant-numeric:tabular-nums;-webkit-font-smoothing:antialiased;text-shadow:0 0 2px #b7ff00,0 0 5px #b7ff00,0 0 11px rgba(183,255,0,1),0 0 20px rgba(132,204,22,.95),0 0 34px rgba(163,230,53,.72),0 0 48px rgba(163,230,53,.38);filter:drop-shadow(0 0 5px rgba(183,255,0,.9));animation:coec-electric 2.4s steps(1,end) infinite}.coec-window{position:relative;z-index:2;min-width:0;flex:1;overflow:hidden;height:29px;display:flex;align-items:center;mask-image:linear-gradient(90deg,transparent,#000 18px,#000 calc(100% - 18px),transparent);-webkit-mask-image:linear-gradient(90deg,transparent,#000 18px,#000 calc(100% - 18px),transparent)}.coec-track{display:flex;width:max-content;align-items:center;will-change:transform}.coec-track span{display:inline-flex;align-items:center;gap:9px;padding-left:17px;color:#b7ff00;font-size:7px;font-weight:900;letter-spacing:.055em;white-space:nowrap;text-shadow:0 0 10px currentColor}.coec-track span:nth-child(3n+2){color:#6ee7b7}.coec-track span:nth-child(3n){color:#c4b5fd}.coec-track b{font-size:10px;opacity:.45;color:#d9ff8a;text-shadow:none}@keyframes coec-live{0%,100%{opacity:.4;transform:scale(.78)}50%{opacity:1;transform:scale(1.2)}}@keyframes coec-electric{0%,18%,20%,48%,50%,100%{opacity:1}19%,49%{opacity:.78}70%{opacity:.94}}@media(max-width:620px){.coec{min-height:29px;margin-bottom:3px}.coec-label{height:23px;padding:0 8px;font-size:6px}.coec-time{font-size:9px;min-width:72px;margin-left:6px}.coec-track span{font-size:6.5px;padding-left:14px;gap:7px}}`;
