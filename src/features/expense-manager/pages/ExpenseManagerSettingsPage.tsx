...
export function ExpenseManagerSettingsPage({ onNavigate }: ExpenseManagerSettingsPageProps) {
  ...
  return <section className="expense-manager-settings" aria-labelledby="expense-manager-settings-title">
    <style>{`
      .expense-manager-settings{width:min(860px,100%);margin:0 auto;padding:0 2px 110px}
      .expense-manager-settings__back{display:inline-flex;align-items:center;gap:6px;margin:0 0 10px;padding:7px 9px;border:1px solid rgba(148,163,184,.16);border-radius:10px;background:rgba(255,255,255,.76);color:#475569;font:inherit;font-size:10px;font-weight:850;cursor:pointer}
      .expense-manager-settings__hero{margin-bottom:14px}.expense-manager-settings__eyebrow{color:#2563eb;font-size:9px;font-weight:900;letter-spacing:.13em;text-transform:uppercase}.expense-manager-settings h1{margin:4px 0 4px;color:#0f172a;font-size:24px;font-weight:950;letter-spacing:-.04em}.expense-manager-settings__intro{margin:0;color:#64748b;font-size:11px;font-weight:650;line-height:1.5}
      ...
      .expense-manager-settings__swatches{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px}.expense-manager-settings__swatch{min-width:0;padding:8px;border:1px solid rgba(148,163,184,.15);border-radius:12px;background:#fff;color:#475569;font:inherit;font-size:8px;font-weight:800;cursor:pointer}.expense-manager-settings__swatch:hover{border-color:rgba(37,99,235,.3)}.expense-manager-settings__swatch[data-active=true]{border-color:#2563eb;box-shadow:0 0 0 2px rgba(37,99,235,.1)}.expense-manager-settings__swatch-dot{width:24px;height:24px;margin:0 auto 5px;border-radius:50%;border:1px solid rgba(15,23,42,.12);box-shadow:inset 0 1px 1px rgba(255,255,255,.4)}
    ...
    <header className="expense-manager-settings__hero"><span className="expense-manager-settings__eyebrow">Dashboard personalization</span><h1 id="expense-manager-settings-title">Overview Settings</h1><p className="expense-manager-settings__intro">Personalize the Expense Manager workspace. Changes are saved on this device and apply to the Overview immediately.</p></header>
