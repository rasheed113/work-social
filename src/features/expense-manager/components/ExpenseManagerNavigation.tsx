  ...
  return (
    <nav className="expense-manager-navigation" aria-label="Expense Manager navigation">
      <style>{`
        ...
        .expense-manager-navigation__mobile-grid{display:grid;grid-template-columns:1.1fr 1.55fr 42px 1.05fr .9fr;align-items:stretch;gap:3px;padding:3px}
        .expense-manager-navigation__more-wrap{position:relative;min-width:0}
        .expense-manager-navigation__more-button{width:100%;min-width:0;min-height:40px;display:flex;align-items:center;justify-content:center;gap:3px;padding:0 3px;border:1px solid transparent;border-radius:9px;background:transparent;color:#475569;font:inherit;font-size:10px;font-weight:800;cursor:pointer;touch-action:manipulation}
        ...
        .expense-manager-navigation__quick-add{width:42px;min-width:42px;min-height:40px;border:1px solid rgba(37,99,235,.2);border-radius:10px;background:linear-gradient(145deg,#2563eb,#4f46e5);color:#fff;font:inherit;font-size:18px;font-weight:900;box-shadow:0 5px 12px rgba(37,99,235,.14);cursor:pointer;touch-action:manipulation}
        @media (max-width:767px){.expense-manager-navigation{padding:0 4px 5px}.expense-manager-navigation__desktop{display:none}.expense-manager-navigation__mobile{display:block}.expense-manager-navigation__mobile-grid{grid-template-columns:1.1fr 1.55fr 42px 1.05fr .9fr;gap:2px;padding:3px}.expense-manager-navigation__item{min-height:40px;padding:0 2px;gap:4px;font-size:10px}.expense-manager-navigation__more-button{min-height:40px;padding:0 2px;font-size:10px}.expense-manager-navigation__icon{font-size:13px}.expense-manager-navigation__quick-add{width:42px;min-width:42px;min-height:40px;font-size:18px}}
        @media (max-width:340px){.expense-manager-navigation__mobile-grid{grid-template-columns:1.05fr 1.6fr 40px 1fr .85fr;gap:1px;padding:2px}.expense-manager-navigation__item,.expense-manager-navigation__more-button{font-size:9px;padding:0 1px}.expense-manager-navigation__icon{font-size:13px}.expense-manager-navigation__quick-add{width:40px;min-width:40px}}
