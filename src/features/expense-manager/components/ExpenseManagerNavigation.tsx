...
export function ExpenseManagerNavigation({ pathname, onNavigate }: ExpenseManagerNavigationProps) {
  ...
  return (
    <nav className="expense-manager-navigation" aria-label="Expense Manager navigation">
      <style>{`
        .expense-manager-navigation{position:sticky;top:0;z-index:40;width:100%;box-sizing:border-box;padding:0 10px 8px}
        .expense-manager-navigation__shell{width:100%;box-sizing:border-box;border:1px solid rgba(148,163,184,.16);border-radius:14px;background:rgba(255,255,255,.94);box-shadow:0 6px 18px rgba(15,23,42,.07),inset 0 1px 0 rgba(255,255,255,.9);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}
        .expense-manager-navigation__desktop{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:4px;padding:4px}
        .expense-manager-navigation__item{min-width:0;min-height:42px;display:flex;align-items:center;justify-content:center;gap:6px;padding:0 8px;border:1px solid transparent;border-radius:10px;background:transparent;color:#475569;font:inherit;font-size:12px;font-weight:800;cursor:pointer;touch-action:manipulation;transition:background .16s ease,border-color .16s ease,color .16s ease}
        ...
        .expense-manager-navigation__icon{font-size:15px;line-height:1;font-weight:900;flex:0 0 auto}
        ...
        .expense-manager-navigation__mobile-grid{display:grid;grid-template-columns:max-content max-content 44px max-content max-content;align-items:stretch;justify-content:space-between;gap:3px;padding:4px}
        .expense-manager-navigation__more-wrap{position:relative;min-width:0}
        .expense-manager-navigation__more-button{width:max-content;min-width:0;min-height:42px;display:flex;align-items:center;justify-content:center;gap:5px;padding:0 6px;border:1px solid transparent;border-radius:10px;background:transparent;color:#475569;font:inherit;font-size:11px;font-weight:800;cursor:pointer;touch-action:manipulation}
        ...
        .expense-manager-navigation__more-panel{position:absolute;right:0;top:calc(100% + 7px);width:min(230px,calc(100vw - 20px));max-height:min(65dvh,340px);overflow:auto;padding:6px;border:1px solid rgba(148,163,184,.2);border-radius:13px;background:rgba(255,255,255,.98);box-shadow:0 14px 30px rgba(15,23,42,.14);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px)}
        .expense-manager-navigation__more-item{width:100%;min-height:42px;display:flex;align-items:center;gap:8px;padding:0 9px;border:1px solid transparent;border-radius:9px;background:transparent;color:#334155;text-align:left;font:inherit;font-size:12px;font-weight:800;cursor:pointer;touch-action:manipulation}
        ...
        .expense-manager-navigation__quick-add{width:44px;min-width:44px;min-height:42px;border:1px solid rgba(37,99,235,.2);border-radius:10px;background:linear-gradient(145deg,#2563eb,#4f46e5);color:#fff;font:inherit;font-size:19px;font-weight:900;box-shadow:0 5px 12px rgba(37,99,235,.16);cursor:pointer;touch-action:manipulation}
        @media (max-width:767px){.expense-manager-navigation{padding:0 4px 6px}.expense-manager-navigation__desktop{display:none}.expense-manager-navigation__mobile{display:block}.expense-manager-navigation__mobile-grid{grid-template-columns:max-content max-content 44px max-content max-content;gap:2px;padding:3px}.expense-manager-navigation__item{min-height:40px;padding:0 3px;gap:4px;font-size:10px}.expense-manager-navigation__more-button{min-height:40px;padding:0 3px;font-size:10px;gap:3px}.expense-manager-navigation__icon{font-size:14px}.expense-manager-navigation__quick-add{width:42px;min-width:42px;min-height:40px;font-size:18px}}
        @media (max-width:340px){.expense-manager-navigation__mobile-grid{grid-template-columns:max-content max-content 40px max-content max-content;gap:1px;padding:3px}.expense-manager-navigation__item,.expense-manager-navigation__more-button{font-size:9px;padding:0 2px}.expense-manager-navigation__icon{font-size:13px}.expense-manager-navigation__quick-add{width:40px;min-width:40px}}
