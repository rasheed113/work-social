...
const styles = {
  ...
  hero: {
    ...
    background: 'linear-gradient(145deg, rgba(4,14,30,.48) 0%, rgba(5,27,51,.34) 54%, rgba(8,20,40,.42) 100%)',
  ...
  searchWrap: { display: 'flex', alignItems: 'center', gap: 10, marginTop: 17, padding: '10px 13px', borderRadius: 13, background: 'rgba(1,10,23,.42)', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', border: '1px solid rgba(91,224,255,.32)', boxShadow: 'inset 0 0 18px rgba(21,157,196,.08), 0 0 18px rgba(21,157,196,.08)' } as React.CSSProperties,
  ...
  section: { marginTop: 16, padding: 16, borderRadius: 22, background: 'linear-gradient(180deg, rgba(7,20,38,.42), rgba(5,15,29,.34))', backdropFilter: 'blur(18px)', WebkitBackdropFilter: 'blur(18px)', color: '#bfefff', border: '1px solid rgba(0,240,255,.16)', boxShadow: '0 14px 36px rgba(0,0,0,.24), inset 0 1px 0 rgba(141,231,255,.08)' } as React.CSSProperties,
  ...
  row: { display: 'grid', gridTemplateColumns: 'minmax(0, 1fr)', gap: 7, padding: 11, marginTop: 8, borderRadius: 17, background: 'rgba(5,18,34,.34)', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', color: '#bfefff', border: '1px solid rgba(91,224,255,.14)', boxShadow: '0 7px 20px rgba(0,0,0,.18), inset 0 1px 0 rgba(141,231,255,.06)', transition: 'transform .18s ease, box-shadow .18s ease' } as React.CSSProperties,
  ...
  alert: { margin: '12px 0 0', padding: '10px 12px', borderRadius: 13, background: 'rgba(120,20,45,.16)', color: '#bfefff', border: '1px solid rgba(255,100,130,.22)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' } as React.CSSProperties,
