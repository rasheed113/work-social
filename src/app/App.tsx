...
export function App() {
  ...
  return <main className="app-shell" style={{ height: '100dvh', minHeight: 0, padding: 0, boxSizing: 'border-box', overflow: 'hidden', width: '100%' }}>
    <div className="ws-new-cosmic-backdrop" aria-hidden="true">
      <span className="ws-new-cosmic-band" />
      <span className="ws-new-cosmic-glow ws-new-cosmic-glow-a" />
      <span className="ws-new-cosmic-glow ws-new-cosmic-glow-b" />
      <span className="ws-new-cosmic-glow ws-new-cosmic-glow-c" />
      <span className="ws-new-cosmic-pulse" />
    </div>
