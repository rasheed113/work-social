...
export function App() {
  ...
  return <main className="app-shell" style={{ height: '100dvh', minHeight: 0, padding: 0, boxSizing: 'border-box', overflow: 'hidden', width: '100%' }}>
    <div className="work-social-router-shell" style={{ height: '100%', width: '100%', maxWidth: '100%', minHeight: 0, minWidth: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}><div className="ws-cosmic-atmosphere" aria-hidden="true"><span className="ws-cosmic-orb ws-cosmic-orb-a" /><span className="ws-cosmic-orb ws-cosmic-orb-b" /><span className="ws-cosmic-orb ws-cosmic-orb-c" /><span className="ws-cosmic-orb ws-cosmic-orb-d" /><span className="ws-cosmic-core" /><span className="ws-cosmic-star-layer ws-cosmic-star-layer-a" /><span className="ws-cosmic-star-layer ws-cosmic-star-layer-b" /><span className="ws-cosmic-star-layer ws-cosmic-star-layer-c" /><span className="ws-cosmic-dust" /><span className="ws-cosmic-streaks" /><span className="ws-cosmic-vignette" /></div>
