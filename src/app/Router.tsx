...
export function Router({ profileId }: RouterProps) {
  ...
  return <><style>{`
    .ws-main-header{position:sticky;top:0;z-index:900;width:100%;max-width:100%;min-width:0;margin:0 0 18px;padding:9px 10px;box-sizing:border-box;display:flex;align-items:center;gap:10px;min-height:64px;overflow:hidden;background:linear-gradient(145deg,rgba(15,23,42,.94),rgba(30,41,59,.91) 52%,rgba(49,46,129,.9));border:1px solid rgba(255,255,255,.12);border-top-color:rgba(255,255,255,.18);border-radius:0 0 18px 18px;box-shadow:0 12px 30px rgba(15,23,42,.22),inset 0 1px 0 rgba(255,255,255,.08);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}
    .ws-main-header::before{content:'';position:absolute;inset:0;pointer-events:none;background:linear-gradient(110deg,rgba(255,255,255,.06),transparent 35%,rgba(255,255,255,.025) 72%,transparent);opacity:.9}
    .ws-main-header__brand,.ws-main-header__chat{position:relative;z-index:1}
    .ws-main-header__brand{display:flex;align-items:center;gap:10px;min-width:0;padding:3px 4px 3px 2px;border:0;border-radius:14px;background:transparent;color:#fff;cursor:pointer;text-align:left;transition:background .18s ease,transform .18s ease}
    .ws-main-header__brand:hover{background:rgba(255,255,255,.06)}
    .ws-main-header__brand:active{transform:translateY(1px)}
    .ws-main-header__logo{width:40px;height:40px;flex:0 0 40px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.2);border-radius:13px;background:linear-gradient(145deg,#67e8f9,#3b82f6 46%,#7c3aed);box-shadow:inset 0 1px 1px rgba(255,255,255,.3),0 7px 15px rgba(37,99,235,.25);font-size:19px;font-weight:900;letter-spacing:-.04em}
    .ws-main-header__title{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:18px;line-height:1.1;font-weight:850;letter-spacing:-.025em;text-shadow:0 1px 10px rgba(0,0,0,.2)}
    .ws-main-header__chat{margin-left:auto;min-width:0;min-height:40px;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:0 13px;border:1px solid rgba(255,255,255,.2);border-radius:13px;color:#fff;background:linear-gradient(145deg,rgba(6,182,212,.9),rgba(37,99,235,.92) 54%,rgba(124,58,237,.9));box-shadow:inset 0 1px 1px rgba(255,255,255,.2),0 8px 18px rgba(37,99,235,.2);font-weight:800;cursor:pointer;white-space:nowrap;transition:transform .18s ease,box-shadow .18s ease,filter .18s ease}
