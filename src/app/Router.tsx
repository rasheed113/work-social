...
import { RealtimePresenceStatus } from './components/RealtimePresenceStatus';
...
export function Router({ profileId }: RouterProps) {
  ...
  const inboxPage:ReactNode=(<><InboxPage profileId={profileId}/><InboxCallControls profileId={profileId}/><RealtimePresenceStatus profileId={profileId}/></>);
