...
export function Router({ profileId }: RouterProps) {
  ...
  return <><style>{`
    ...
    @media (max-width:340px){.ws-main-header{gap:5px}.ws-main-header__brand{gap:6px;padding-left:0;padding-right:0}.ws-main-header__logo{width:36px;height:36px;flex-basis:36px;font-size:16px}.ws-main-header__title{font-size:14px}.ws-main-header__tagline{font-size:6px;letter-spacing:.075em}.ws-main-header__chat{padding:0 7px;font-size:12px;gap:4px}}
