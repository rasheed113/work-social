...
export function Router({ profileId }: RouterProps) {
  ...
  return <><header style={{ position: 'sticky', top: 0, zIndex: 900, width: 'calc(100% + 32px)', marginLeft: -16, marginBottom: 18, boxSizing: 'border-box', display: 'flex', alignItems: 'center', gap: 7, minHeight: 64, padding: '9px 10px', borderBottom: '1px solid rgba(255,255,255,.16)', background: 'linear-gradient(135deg, #111827 0%, #18243a 48%, #24144a 100%)', boxShadow: '0 10px 28px rgba(15,23,42,.28), inset 0 1px 0 rgba(255,255,255,.12)', overflow: 'hidden' }}>
  ...
  </header><div style={{ minWidth: 0, paddingBottom: 92 }}>{pages[route]}</div><nav aria-label="Main navigation" style={{ position: 'fixed', left: 10, right: 10, bottom: 'calc(10px + env(safe-area-inset-bottom))', zIndex: 1000, display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 7, padding: 8, boxSizing: 'border-box', background: 'linear-gradient(145deg, rgba(15,23,42,.97), rgba(30,41,59,.96) 52%, rgba(49,46,129,.96))', border: '1px solid rgba(255,255,255,.16)', borderRadius: 22, boxShadow: '0 16px 38px rgba(15,23,42,.34), inset 0 1px 0 rgba(255,255,255,.16)', backdropFilter: 'blur(18px)', WebkitBackdropFilter: 'blur(18px)' }}>
