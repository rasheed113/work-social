...
export function Router({ profileId }: RouterProps) {
  ...
  const inboxPage:ReactNode=(<><InboxPage profileId={profileId}/><StableInboxCallControls key={locationVersion} profileId={profileId}/><CallSpeakerEnhancer key={`speaker-${locationVersion}`} /></>);
