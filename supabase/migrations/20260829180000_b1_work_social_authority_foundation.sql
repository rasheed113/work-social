...
revoke all on table private.work_social_authority_subjects from anon, authenticated;
revoke all on table private.work_social_authority_grants from anon, authenticated;
