-- Surface a real Edited indicator in the contractor Team Work feed.
-- Revision 1 is created on the original insert; revision 2+ means the worker edited the entry.
