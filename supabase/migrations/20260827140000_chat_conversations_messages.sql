...
create unique index if not exists conversations_direct_pair_idx on public.conversations(direct_user_a, direct_user_b) where kind = 'direct';
...
create policy conversations_creator_update on public.conversations for update to authenticated
